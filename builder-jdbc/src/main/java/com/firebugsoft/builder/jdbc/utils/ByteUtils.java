...
public final class ByteUtils {
    ...
    public static int indexOf(byte[] source, int startIndex, byte... findContent) {
    ...
    public static int indexOfIgnoreCase(byte[] source, int startIndex, byte... findContent) {
    ...
    public static List<Integer> indexesOf(byte[] source, int startIndex, byte... findContent) {
    ...
    public static List<Integer> indexesOfIgnoreCase(byte[] source, int startIndex, byte... findContent) {
        List<Integer> indexes = new LinkedList<Integer>();
        while (true) {
    ...
    public static byte[] replaceFirstIgnoreCase(byte[] source, byte[] findContent, byte[] replaceContent) {
    ...
    public static byte[] replaceAllIgnoreCase(byte[] source, byte[] findContent, byte[] replaceContent) {
